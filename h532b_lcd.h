...
// Resolution 200 * 40
#define	LCD_COLUMN_END		67		// 67*3=201
...
#define MAX_CHAR			32		// 전체 LCD 에 출력 가능한 최대 문자수
#define MAX_LINE			4		// 전체 LCD 에 출력 가능한 최대 라인 수
#define MAX_COLUMN			8		// 한 라인에 출력 가능한 최대 문자수
#define FONT_HEIGHT			16		// 폰트 높이
#define FONT_WIDTH			16		// 폰트 너비
